        ...
        <div class="col-md-9">
          <div class="bread-crumb">
            <ul>
              ...
              <li>\</li>
              <li><a href="<?= base_url('assets/user/'); ?>cart.html">cart</a></li>
              <li>\</li>
              <li><a href="<?= base_url('assets/user/'); ?>checkout.html">Checkout</a></li>
            </ul>
          </div>
        </div>
      </div>
        ...
        <div class="col-lg-12 col-md-12  col-sm-12 Authentication">
          ...
          <div class="row">
            ...
            <div class="col-xs-12 col-sm-4 ">
              ...
              <form class="registered">
                ...
                <div class="forgot-password">
                  <p><a href="<?= base_url('assets/user/'); ?>forgot-password.html" title="Recover your forgotten password">Forgot your password? </a></p>
                </div>
            ...
            <div class="col-xs-12 col-sm-4 guest">
              ...
              <a class="btn btn-primary" href="<?= base_url('assets/user/'); ?>checkout-step1.html"><i class="fa fa-sign-in"></i> Checkout as Guest</a> </div>
          </div>
        </div>
      </div>
    </div>
