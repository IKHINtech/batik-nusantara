                    ...
                    <div class="product-block ">
                      ...
                      <div class="product-details">
                        ...
                        <div class="product-hov">
                          <ul>
                            <li class="wish"><a href="<?= base_url('assets/user/'); ?>#"></a></li>
                            <li class="addtocart"><a href="<?= base_url('assets/user/'); ?>#">Add to Cart</a> </li>
                            <li class="compare"><a href="<?= base_url('assets/user/'); ?>#"></a></li>
                          </ul>
